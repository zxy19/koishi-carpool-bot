...
export async function getGameByChannel(ctx: Context, channel: string, platform: string): Promise<Game[]> {
    return await ctx.model.get('carpool_game', { channel, platform });
}
